...
export class LoadRemoteUser {
    static readonly type = '[Drive] Load Remote User';
    constructor(public user: RemoteUser) {}
}
...
export class IsConnect {
    static readonly type = '[Drive] Is Connect';
}
